(function () {
  ...
  class Live2dV3 { // eslint-disable-line no-unused-vars
    constructor ({ basePath, modelName, width = 300, height = 300, el, sizeLimit, mobileLimit, sounds }) {
      ...
      window.onresize = (event) => {
        ...
        if (this.model) {
          this.model.position = new PIXI.Point((width * 0.35), (height * 0.5))
          this.model.scale = new PIXI.Point((this.model.position.y * 2), (this.model.position.y * 2))
      ...
      document.addEventListener('mousemove', (event) => {
        ...
        if (this.model) {
          const mouseX = this.canvaspos.left + this.model.position.x - event.clientX
          const mouseY = this.canvaspos.top + this.model.position.y - event.clientY
